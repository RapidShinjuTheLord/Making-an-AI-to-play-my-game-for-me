...
class StayingAlive(Env):
    def __init__(self, will_render = False):
        ...
        #obs space
        self.observation_shape = (151,151,6)
    ...
    def draw_elements_on_canvas(self):
        ...
        for danger in self.board.obstacles[::-1]:
            if danger.index == 'flame':
                ...
                if danger.axis:
                    self.canvas[0][int(danger.pos/4)][4] = danger.time/danger.initial_time
                elif not danger.axis:
                    self.canvas[int(danger.pos/4)][0][4] = danger.time/danger.initial_time
            elif danger.index == 'plasma':
                self.canvas[int(danger.pos[0]/4)][int(danger.pos[1]/4)][5] = 1
                #self.canvas[int( danger.pos[0]/4 + danger.vector[0]/200 )][int( danger.pos[1]/4 + danger.vector[1]/200 )][6] = 1
